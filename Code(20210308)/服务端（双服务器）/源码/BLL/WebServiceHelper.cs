...
namespace ADServer.BLL
{
    ...
    public class WebServiceHelper
    {
        ...
        /// <param name="args">参数列表</param>   
        /// <returns>返回调用结果</returns>
        public static object InvokeWebService(string wsUrl, string methodName, PfSoapHeader soapHeader, object[] args)
        {
        ...
        /// <param name="args">参数列表</param>   
        /// <returns>返回调用结果</returns>   
        public static object InvokeWebService(string wsUrl, string className, string methodName, PfSoapHeader soapHeader, object[] args)
        {
            ...
            catch (Exception ex)
            {
                ...
                if (!File.Exists(file))
                {
                    ...
                    sw.Write("WebService_Exception");
                    sw.Write("Exception : " + ex.ToString());
                    if (ex.InnerException != null)
                    {
                        sw.Write("InnerException_Message : " + ex.Message);
                    }
                    sw.Close();
                    fs.Close();
                }
        ...
        public class PfSoapHeader
        {
            ...
            public PfSoapHeader(string className)
            {
            ...
            public PfSoapHeader(string className, Dictionary<string, object> properties)
            {
                this.ClassName = className;
